...
class PermissionRule:
    """权限规则"""
    pattern: str
    tool: Optional[ClaudeCodeTool] = None
...
class PermissionManager:
        ...
        presets = {
            ...
            "development": {
                "allowed_tools": [
                    ...
                    "LS", "TodoWrite", "Task", "WebSearch", "WebFetch"
                ],
                "denied_tools": [],
                "allow_rules": [
    ...
    def validate_command(self, full_command: str) -> Tuple[bool, Optional[str]]:
        """
        验证完整命令
