...
class ContextManager:
    ...
    def get_context(self, session_id: str) -> Optional[ClaudeCodeContext]:
        """获取上下文"""
    ...
    def import_context(self, data: Dict[str, Any]) -> ClaudeCodeContext:
        ...
        for msg_data in data.get("history", []):
            ...
            history.append(ClaudeCodeMessage(
                role=msg_data["role"],
    ...
    def load_from_file(self, filepath: str) -> Optional[ClaudeCodeContext]:
        """从文件加载上下文"""
        try:
    ...
    def get_context_summary(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "context_keys": list(context.context_data.keys()) if context.context_data else []
        }